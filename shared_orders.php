...
echo '<table height="30%" width="100%"><tr><td bgcolor="#6495ed" style="border-collapse: collapse">Сохраненные заявки<br>';
...
/** Форма объявлений */
echo '<table height="10%" width="100%"><tr><td bgcolor="#eee8aa" style="border-collapse: collapse"><br>';
echo "</td></tr></table><p>";
