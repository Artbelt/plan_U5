...
$sql = "INSERT INTO salon_filter_structure(filter, category, paper_package, insertion_count, box, g_box, comment) 
        VALUES ('$filter_name','$category','$p_p_name','$insertion_count','$box','$g_box','$remark');";
